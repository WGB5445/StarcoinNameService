...
module SNSadmin::Record{
    ...
    public fun new_address_record<ROOT:store>():AddressRecord<ROOT> {
        AddressRecord<ROOT>{
            addresses :Table::new<vector<u8>,vector<u8>>(),
            all       :Vector::empty<vector<u8>>()
        }
    ...
    public fun change_address_record<ROOT:store>(obj:&mut AddressRecord<ROOT> , name:&vector<u8>, addr:&vector<u8>)acquires AddressRecordAllow{
    ...
    public fun remove_address_record<ROOT:store>(obj:&mut AddressRecord<ROOT> , name:&vector<u8>){
    ...
    public fun get_address_record<ROOT:store>(obj:&AddressRecord<ROOT>, name:&vector<u8>):Option::Option<vector<u8>>{
    ...
    //     let list = &borrow_global<ContentRecordAllow>(Config::creater()).list;
    ...
    //     let allow = borrow_global_mut<ContentRecordAllow>(Config::creater());
    //     let list = &mut allow.list;
